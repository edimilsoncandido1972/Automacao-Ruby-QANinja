...
Funcionalidade: Restaurantes
    Para que eu possa saber quais os restaurantes disponiveis com o tempo de entrega e nota de avaliação
    ...
    Cenario: Categorias
        ...
        Quando acesso a lista de restaurantes
        Então cada restaurante deve exibir sua cateforia
    ...
    Cenario: Nota de avaliação 
        ...
        Quando acesoo a lista de restaurantes
